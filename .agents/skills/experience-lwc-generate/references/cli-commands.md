...
If Jest reports errors from `.agents/`, `.cursor/`, `.agents/`, or `.pi/`, it is discovering files outside your real Salesforce source tree. Scope Jest to `force-app` and ignore agent folders.
