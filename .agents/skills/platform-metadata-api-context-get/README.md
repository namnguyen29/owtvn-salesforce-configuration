...
This skill is designed for use with Codex. To use it:

1. Ensure this directory is in your Codex skills path
...
_Generated by `skill-generator/scripts/generate_metadata_skill.py` in [`metadata-api-emu/sfdc-apis-llm-context`](https://github.com/metadata-api-emu/sfdc-apis-llm-context)._
