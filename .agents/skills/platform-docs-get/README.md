...
The installer sets up an isolated runtime under `~/.agents/.platform-docs-get-runtime`, installs those Python packages there, and installs the Playwright Chromium browser automatically during install/update.
