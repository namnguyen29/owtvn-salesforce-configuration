...
Salesforce data operations skill for Codex. Create, validate, bulk-load, clean up, and troubleshoot org data with a describe-first workflow.
...
- Codex with skill plugins enabled
